...
from .clustering import cluster_cells_spatial, cluster_cells_spatio_biological
...
def hierarchical_pairwise_align(
    ...
    **kwargs
    ...
    labelsA = cluster_cells_spatio_biological(sliceA, spatial_key=spatial_key, use_rep=use_rep, resolution=resolution)
    labelsB = cluster_cells_spatio_biological(sliceB, spatial_key=spatial_key, use_rep=use_rep, resolution=resolution)
